...
import com.fruitshop.portal.service.ContentService;
...
public class ContentServiceImpl implements ContentService {
	...
	public String getContentList() {
		...
		//把字符串转换成FruitshopResult
		try {
			FruitshopResult fruitshopResult = FruitshopResult.formatToList(result, TbContent.class);
			//取内容列表
			List<TbContent> list = (List<TbContent>) fruitshopResult.getData();
